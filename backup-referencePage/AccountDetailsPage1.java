...
public class AccountDetailsPage1 extends BaseClass {
	
	WebDriver driver;
	public AccountDetailsPage1(WebDriver driver)
	{
		this.driver=driver;
...
//    }
	...
	{	
		...
		// WebElement dropdownElement = waitForElementVisible(name, 30);
//		    Select select = new Select(dropdownElement);
//		    select.selectByIndex(1);
		
		
//     	Select oselect=new Select(name);
//		oselect.selectByVisibleText("manish");
