...
public class StartVisitTest extends BaseClass {
	...
	public void StartVisit() throws InterruptedException, AWTException
	{
		...
		search_box.sendKeys("Bhargavi KK");
	    ...
	    Thread.sleep(3000);
	     ...
	     Thread.sleep(4000); // Wait for any DOM changes (can be replaced with wait if needed)   
	     WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	     boolean buttonGone = wait.until(ExpectedConditions.invisibilityOfElementLocated(StartVisitPage.validateStartVisitButton1()));

	     Assert.assertTrue(buttonGone, "Start Visit button should be gone after submission.");
	     System.out.println("Test Passed: Start Visit button disappeared after submission.");
