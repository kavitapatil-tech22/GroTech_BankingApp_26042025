...
public class CreateNewAppointmnetTest extends BaseClass
{
	...
	public void CreateAppointmnet() throws InterruptedException, AWTException
	{
		...
		driver.findElement(CreateNewAppointmentPage.clickOnDay()).sendKeys("12");
		Thread.sleep(1000);
		...
		driver.findElement(CreateNewAppointmentPage.enterTime()).sendKeys("06:00");
		...
		driver.findElement(CreateNewAppointmentPage.enterDuration()).clear();
		...
		driver.findElement(CreateNewAppointmentPage.enterNote()).sendKeys("Appointment for Bhargavi KK ");
		Thread.sleep(1000);		
        ...
        String patientName = "Bhargavi KK"; // Replace with actual dynamic name
