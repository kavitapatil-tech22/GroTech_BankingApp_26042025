...
public class RegisterPatientTest extends BaseClass
{
	...
	public void addPatient(String fn,String ln, String age,String add) throws InterruptedException
	{
		...
		/* validating Patient registration Successful or not */
		addExplicitWait(RegisterPage.validatePatientID());
		WebElement patId=driver.findElement(RegisterPage.validatePatientID());
		Assert.assertTrue(patId.isDisplayed(), "Patient Registration failed: Patient ID is not visible");
		System.out.println("Patient Registration Test case is successful");
