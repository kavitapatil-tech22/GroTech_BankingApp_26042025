...
public class RecordPatientVitalsTest extends BaseClass
{
	...
	public static void addPatientVitals() throws InterruptedException
	{
		...
		addExplicitWait3(RecordPatientVitalsPage.clickPatName());
		driver.findElement(RecordPatientVitalsPage.clickPatName()).click();
		...
		driver.findElement(RecordPatientVitalsPage.enterNotes()).sendKeys("Record vital details for Archana Arun");
